...
const SLIDE_ITEM_PROPS: Record<string, any> = {
  ...
  bodyRight: { type: "string", description: "Right-hand column text. two-column, photo-rail and three-column." },
