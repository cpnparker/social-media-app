      ...
      properties: {
        ...
        editSlide: {
          ...
          properties: {
            ...
            layout: {
              type: "string",
              enum: ["content", "cards", "section", "cover", "case-study", "dark-index", "image-split", "feature", "closing", "two-column", "statement", "stat", "bar-chart", "stacked-bar", "line-chart", "table", "comparison", "swot", "matrix", "scatter", "venn", "timeline", "timeline-parallel", "process", "logo-wall", "quote", "image-grid"],
              description:
