...
- **A deck of text slides is a bad deck.** Their real decks are pictures with captions: most slides carry a photograph. Give the cover, section dividers and closing an \`image.query\`, use \`image-split\` wherever a point has any visual dimension, \`image-grid\` for examples and portfolios, and \`feature\` for a moment of emphasis. Aim for at least half the slides carrying an image, a drawn timeline or a grid.
