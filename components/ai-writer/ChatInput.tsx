...
const ChatInput = forwardRef<ChatInputHandle, ChatInputProps>(
  function ChatInput({ onSend, onStop, disabled, isStreaming, placeholder = "Type your message...", bottomSlot, endSlot }, ref) {
    ...
    // Upload state and logic are shared with the EngineAI home composer — see
    // use-file-uploads.tsx. Two byte-identical copies existed, and improving
    // this one never reached the screen where a new chat with an attachment
    // actually begins.
